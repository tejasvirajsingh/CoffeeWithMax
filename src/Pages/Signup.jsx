            ...
            <p className=" text-sm text-gray-500 mb-4 text-center">Choose a usrname for your page</p>
             ...
             {/* Donmain Input Section  */}
               ...
               <div className="flex items-center border rounded-lg overflow-hidden bg-gray-100 mb-6">
                ...
                <input type="text" placeholder="enter your name here" className="flex-1 bg-transparent px-2 py-2 outline-none text-gray-800 text-sm"></input>
               </div>
               <button className="w-full bg-coffeeBrown hover:bg-opacity-90 text-white font-semibold py-2 rounded-lg transition text-sm mb-3 ">Sign up</button>
               <p className="text-xs text-gray-500 text-center" >By continuing, you agree to { " "} 
                <a href="#" className="underline" >terms of Servies</a> {" "} and { " "}
